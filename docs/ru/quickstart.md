...
1. Скачайте и установите последнюю версию мода для вашего загрузчика со страницы Modrinth: https://modrinth.com/mod/tgbridge.
   Не забудьте установить зависимости, указанные на странице версии.
2. Запустите сервер
...
Если вам нужен прокси для подключения к Telegram, вы можете настроить его в секции конфига
[`advanced.proxy`](/ru/reference#advanced-proxy).

Узнать больше о функционале мода можно на страницах [Фичи](/ru/features) и [Команды](/ru/commands).
