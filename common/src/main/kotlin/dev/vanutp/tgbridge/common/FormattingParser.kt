...
object FormattingParser {
    ...
    fun formatMinecraftComponent2TgEntity(message: Component, startThisComponentOffset: Int = 0): List<TgEntity> {
        val components = message.children()
    ...
    fun getEntityNamesFromComponent(component: Component): List<String> {
        ...
        when {
            ...
            isDecorationsEquals(component, lang.minecraft.messageFormatting.mentionFormatting)
            ...
            isDecorationsEquals(component, lang.minecraft.messageFormatting.hashtagFormatting)
            ...
            isItSpoiler(component) -> output.add("spoiler")
            ...
            isIt(component, TextDecoration.BOLD, output) -> output.add("bold")
            isIt(component, TextDecoration.ITALIC, output) -> output.add("italic")
            isIt(component, TextDecoration.UNDERLINED, output) -> output.add("underline")
            isIt(component, TextDecoration.STRIKETHROUGH, output) -> output.add("strikethrough")
    ...
    fun isIt(component: Component, decorations: List<TextDecoration>, othersOfThis: List<String> = emptyList()): Boolean = isDecorationsEquals(component, decorations) && !othersOfThis.any {
    ...
    fun isIt(component: Component, decoration: TextDecoration, othersOfThis: List<String> = emptyList()): Boolean = isIt(component, listOf(decoration), othersOfThis)
}