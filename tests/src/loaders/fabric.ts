...
export class FabricServer extends Server {
  ...
  protected override getDependencies() {
    const FABRIC_API_MAP = {
      ...
      '1.20.4':
        'https://cdn.modrinth.com/data/P7dR8mSH/versions/QVBohPm2/fabric-api-0.97.2%2B1.20.4.jar',
      '1.20.2':
        'https://cdn.modrinth.com/data/P7dR8mSH/versions/8GVp7wDk/fabric-api-0.91.6%2B1.20.2.jar',
      '1.20.1':
      ...
      '1.19.2':
        'https://cdn.modrinth.com/data/P7dR8mSH/versions/6g95K303/fabric-api-0.77.0%2B1.19.2.jar',
    }
